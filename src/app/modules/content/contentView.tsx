...
interface ContentViewPropsInterface {
    datasource: any;
    metadata: any;
}

interface ContentViewStateInterface {
}

class ContentView extends React.Component<ContentViewPropsInterface, ContentViewStateInterface> {
    constructor(props: ContentViewPropsInterface, context: any) {
        super(props, context);
    }
...
export {
    ContentViewPropsInterface,
    ContentViewStateInterface,
    ContentView,
}
